  ...
  try {
    ...
    if($count == 1){
      ...
      try {
        ...
        echo "Your vote has succesfully been send. If you like you could check your vote by scanning the QR code<br>";
        echo "Click <a href='../index.php'>here</a> to return to Start";

        // Request QR code
        echo "<img src='https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=http://10.110.140.57/hackaton/api/getVote.php?UID=$UID'/>";
